...
export default function AuthorizedMenu({ user }: { user: User }) {
  ...
  return (
    <Menu>
      ...
      >
        <Menu.Items className="absolute top-[84%] z-[9999] mt-4 w-56 rounded-md bg-light py-1.5 text-dark shadow-dropdown ltr:right-0 ltr:origin-top-right rtl:left-0 rtl:origin-top-left dark:bg-dark-250 dark:text-light">
