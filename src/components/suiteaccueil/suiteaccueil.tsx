...
export default function CubeStatique() {
    return (
        <>
            ...
            <section className="w-full bg-white flex flex-col md:flex-row items-center justify-between px-6 py-6">
                {/* --- Bloc texte à gauche ---    */}
                <div className="w-full text-left mb-8">
                    <h2 className="text-2xl md:text-2xl font-extrabold text-gray-900 mb-4 leading-tight">
                        ...
                        <span className="font-bold">150 pavillons digitaux.</span>
                    </h2>
                </div>
                ...
                <div className="w-full md:w-1/2 grid grid-cols-2 gap-6 md:gap-10 text-[#8B005D] font-mono">
                    ...
                    <div className="flex flex-col items-start space-y-1 transition-transform duration-300 hover:scale-105">
                        ...
                        <span className="text-black text-[14px]">Produits</span>
                    </div>
                    ...
                    <div className="flex flex-col items-start space-y-1 transition-transform duration-300 hover:scale-105">
                        <Image
                            src={Suite2}
                            alt="Icône Fournisseurs"
                            width={40}
                            height={40}
                            className="mb-2"
                        />
                        <p className="text-[22px] md:text-[26px] font-semibold">+ 50000</p>
                        <span className="text-black text-[14px]">Fournisseurs</span>
                    </div>
                    ...
                    <div className="flex flex-col items-start space-y-1 transition-transform duration-300 hover:scale-105">
                        ...
                        <span className="text-black text-[14px]">Pays et régions</span>
                    </div>
                </div>
