...
const Banner: React.FC<BannerProps> = ({ name, coverImage, logo, shopId }) => {
  return (
    <div className="shopBanner relative w-full">
      ...
      <div className="relative z-10 h-full w-full bg-white/[0.10] px-4 pt-10 pb-16 text-center backdrop-blur-sm dark:bg-dark/[0.85] lg:px-8 lg:pt-14 lg:pb-20">
        ...
        <div className="hidden mt-3.5 flex justify-center md:mt-4 lg:mt-5">
