    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-white via-slate-50 to-slate-100 flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <motion.div
                ...
                >
                    Votre demande pour devenir fournisseur sur <span className="font-semibold text-slate-800">GalileeCommerce</span> a bien été envoyée.
                    <br /><br />
                    Nous sommes ravis de vous compter parmi les futures B spaces de notre plateforme. ✨
                    <br /><br />
                    Notre équipe est actuellement en train d'examiner votre dossier et reviendra vers vous sous peu. Merci pour votre confiance.
                </motion.p>
            </motion.div>
