...
import ImageHomePagebackground from '@/assets/images/bunch-black-friday-gifts-golden-shopping-cart-with-copy-space.jpg';
  ...
  return (
    <>
      <Seo
        ...
        description="Understand the licensing terms and conditions for our products."
