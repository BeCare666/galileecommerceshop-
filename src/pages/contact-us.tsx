...
import ImageHomePagebackground from '@/assets/images/background5.webp';
  ...
  return (
    <>
      ...
      <div className="mx-auto flex h-full w-full max-w-screen-xl flex-col p-4 sm:p-5">
        ...
        <Maps />
        <div className="mt-6 flex w-full flex-col overflow-hidden rounded-md px-4 py-5 sm:px-6 sm:py-8 md:bg-light md:p-10 md:shadow-card md:dark:bg-dark-200 md:dark:shadow-none lg:flex-row lg:p-0">
