...
import Termes_conditions from '@/components/termes_conditions/termes_conditions';
...
const ChartePage: NextPageWithLayout = () => {
...
ChartePage.getLayout = function getLayout(page) {
